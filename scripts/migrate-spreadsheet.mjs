...
const dataset = {
  ...
  servicos, demandas: [], ordens: [], colaboradores: [], apontamentos: [], medicoes: [], insumos: [], composicoes: [], orcamentos: [], pedidos: [], conjuntos: [], avancos: [], apontamentosEstacao: [], romaneios: [], itensEstoque: [], movimentosEstoque: [], treinamentos: [], fotos: [], funcoes: [], alocacoes: [],
