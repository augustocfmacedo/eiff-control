// Mission Control · Governança — a camada de evidência: prontidão por gates, marcos, bloqueios, escada de
// liberação, frentes, camadas, gates e benefícios. Tudo aqui é SNAPSHOT derivado do código no build
// (MC-CONSTRUCTION-1 só mudou o LUGAR: saiu da primeira dobra e virou aba; nada foi removido).
//
// Nada é calculado aqui: todo número vem de src/core/central/missionControl.ts, sempre como contagem de
// gates fechados sobre gates exigidos. A tela mostra a conta ao lado do número.
...
export default function Governanca() {
  ...
  return (
    <div className="mc-gov">
      ...
      {/* -------------------------------------------------------------- Architecture Map */}
      <div className="card" style={{ marginTop: 16 }}>
        <h2>Camadas da Central</h2>
        <p className="small muted">Cada seta é uma fronteira: quebrou uma, para. A prontidão de cada camada é a contagem dos gates daquela camada. O grafo completo, com dependências, está na aba Mapa vivo.</p>
