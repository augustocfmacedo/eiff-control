      ...
      {aba === 'parametros' && (
        <div className="card">
          <div className="form">
            ...
            <Field label="Corte do extrato (OFX)" hint="Movimentos do extrato anteriores a esta data ficam fora da posição, da conciliação e das importações; nada é apagado"><Input type="date" value={params.corteExtrato ?? ''} disabled={!podeParams} onChange={(e) => setParams({ ...params, corteExtrato: e.target.value || undefined })} /></Field>
