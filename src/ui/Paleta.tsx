...
export const ROTAS_NAV: { to: string; rotulo: string; grupo: string; icone: IconName; permissao?: string }[] = [
  ...
  { to: '/diretor', rotulo: 'Diretor Financeiro', grupo: 'Financeiro', icone: 'chat' }, { to: '/compras', rotulo: 'Compras e pedidos', grupo: 'Financeiro', icone: 'compras' }, { to: '/pagar', rotulo: 'Contas a pagar', grupo: 'Financeiro', icone: 'pagar' }, { to: '/receber', rotulo: 'Contas a receber', grupo: 'Financeiro', icone: 'receber' }, { to: '/lancamentos', rotulo: 'Lançamentos', grupo: 'Financeiro', icone: 'lancamentos' }, { to: '/aprovacoes', rotulo: 'Central de aprovações', grupo: 'Financeiro', icone: 'aprovacoes' },
  ...
  { to: '/mission-control', rotulo: 'Mission Control · EIFF Central', grupo: 'Administração', icone: 'checks', permissao: 'ver_auditoria' },
];
