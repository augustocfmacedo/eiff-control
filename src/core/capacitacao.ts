...
export const LICOES: Licao[] = [
  ...
  },
  {
    ...
    passos: [
      'Equipe: em Diretor Financeiro, escreva o que precisa pagar, quanto, para quando e para quem (ex.: "frete de R$ 500 amanhã para a Transportadora X, obra Smart Fit"). Ele anota, pede o que faltar e, ao confirmar, encaminha à Diretoria. Saldo e caixa não são mostrados à equipe.',
      'Equipe: "Meus pedidos" mostra o andamento (aguardando, validado e programado, na alçada, reagendado, não aprovado com motivo, pago). O painel avisa quando um pedido seu foi decidido.',
      'Diretoria/Financeiro: a Central traz o briefing do dia e cada pedido já orientado (programar, reagendar para a data em que cabe, seu aval quando consome a reserva, não recomendado) com o impacto no caixa e a alçada. Um clique segue a recomendação; "Programar mesmo assim", "Outra data" e "Recusar" (com motivo) sempre disponíveis.',
      'Diretoria: a agenda mostra o caixa dos 7 dias com e sem os pedidos e os decididos recentes. Na aba "Conversar com o Diretor" valem as perguntas com números: "como está o caixa?", "o que vence essa semana?".',
    ],
