...
export const REGRAS_PERSONA_PADRAO: RegraPersona[] = [
  ...
  // lideranca industrial explicita no CARGO: funcao industrial/producao (persona MANUFACTURING), a senioridade continua vindo do nivel/cargo
  rp('MANUFACTURING', 'cargo', ['gerente industrial', 'gerente de producao', 'gerente fabril', 'gerente de fabrica', 'gerente de manufatura', 'gerente de planta', 'industrial manager', 'plant manager', 'production manager', 'manufacturing manager', 'head industrial', 'coordenador industrial', 'supervisor industrial', 'encarregado industrial']),
  ...
  rp('LOGISTICS', 'ambos', ['logistica', 'logistics', 'distribuicao', 'transportes', 'armazem', 'warehouse', 'almoxarifado', 'cd']),
