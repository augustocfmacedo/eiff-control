...
export const PLAYBOOKS: Record<PlaybookCodigo, DefinicaoPlaybook> = {
  ...
  REFERRAL_INTRODUCTION: { codigo: 'REFERRAL_INTRODUCTION', nome: 'Apresentação por indicação', objetivo: 'START_DISCOVERY', personasPreferidas: [...TECNICOS, ...OPERACIONAIS], tom: 'tecnico_consultivo', fazer: ['abrir citando quem indicou SOMENTE quando a divulgação da fonte estiver autorizada (sourceDisclosure ALLOWED); senão usar a abertura neutra do objetivo (aberturaNeutra), que nunca apresenta o destinatário como responsável pela frente', 'ligar ao fato do sinal', 'pedir uma conversa curta para entender a frente'], naoFazer: ['vender', 'revelar o nome de quem indicou sem autorização', 'mandar proposta'], elementosObrigatorios: ['origem da indicação (só se autorizada)', 'fato verificado', 'uma frase sobre a EIFF', 'pedido de conversa curta'], elementosProibidos: ['preço', 'portfólio sem pedido'], objecoes: OBJECOES_TECNICAS, maxPalavras: { WHATSAPP: 90, EMAIL: 130, PHONE: 110, LINKEDIN: 70 } },
...
// ---------------------------------------------------------------------------------------------------------------------
export const PLAYBOOK_VERSION = '1.2'; // 1.2: REFERRAL_INTRODUCTION sem a frase antiga de presunção de responsabilidade
